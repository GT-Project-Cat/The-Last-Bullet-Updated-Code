...
void ClientCommand( edict_t *pEntity )
{
	...
	{
		int li_Dist = CVAR_GET_FLOAT("npc_create_dist");//���������� ����������
		char* ls_Arg = (char*)STRING(MAKE_STRING(CMD_ARGV(1))); // ���������� ��� npc/entity  
		UTIL_MakeVectors(Vector(0, pev->v_angle.y, 0));//������� ������, ���������� �������
		CBaseEntity::Create(ls_Arg, pev->origin + gpGlobals->v_forward * li_Dist, pev->angles);//������� entity
	}
	else
	{
